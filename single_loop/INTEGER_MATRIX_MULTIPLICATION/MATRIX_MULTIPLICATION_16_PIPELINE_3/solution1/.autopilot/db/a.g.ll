; ModuleID = '/opt/Xilinx/Vivado_HLS/2017.2/bin/INTEGER_MATRIX_MULTIPLICATION/MATRIX_MULTIPLICATION_16_PIPELINE_3/solution1/.autopilot/db/a.g.bc'
...
define void @_Z9matrixmulPA3_cS0_PA3_s([3 x i8]* %a, [3 x i8]* %b, [3 x i16]* %res) nounwind uwtable {
  ...
  %7 = load [3 x i8]** %1, align 8, !dbg !46      ; [#uses=1 type=[3 x i8]*] [debug line = 9:1]
  %8 = load [3 x i8]** %2, align 8, !dbg !46      ; [#uses=1 type=[3 x i8]*] [debug line = 9:1]
  call void (...)* @_ssdm_SpecArrayPartition([3 x i8]* %7, [3 x i8]* %8, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !46 ; [debug line = 9:1]
  br label %9, !dbg !46                           ; [debug line = 9:1]
...
; <label>:13                                      ; preds = %10
  ...
  br label %14, !dbg !51                          ; [debug line = 11:36]

; <label>:14                                      ; preds = %13
  call void @llvm.dbg.declare(metadata !{i32* %j}, metadata !53), !dbg !55 ; [debug line = 14:18] [debug variable = j]
  store i32 0, i32* %j, align 4, !dbg !56         ; [debug line = 14:23]
  br label %15, !dbg !56                          ; [debug line = 14:23]

; <label>:15                                      ; preds = %65, %14
  %16 = load i32* %j, align 4, !dbg !56           ; [#uses=1 type=i32] [debug line = 14:23]
  %17 = icmp slt i32 %16, 3, !dbg !56             ; [#uses=1 type=i1] [debug line = 14:23]
  br i1 %17, label %18, label %68, !dbg !56       ; [debug line = 14:23]

; <label>:18                                      ; preds = %15
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !57 ; [debug line = 14:38]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !57 ; [debug line = 14:38]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !59 ; [debug line = 15:1]
  %19 = load i32* %j, align 4, !dbg !60           ; [#uses=1 type=i32] [debug line = 17:7]
  %20 = sext i32 %19 to i64, !dbg !60             ; [#uses=1 type=i64] [debug line = 17:7]
  %21 = load i32* %i, align 4, !dbg !60           ; [#uses=1 type=i32] [debug line = 17:7]
  %22 = sext i32 %21 to i64, !dbg !60             ; [#uses=1 type=i64] [debug line = 17:7]
  %23 = load [3 x i16]** %3, align 8, !dbg !60    ; [#uses=1 type=[3 x i16]*] [debug line = 17:7]
  %24 = getelementptr inbounds [3 x i16]* %23, i64 %22, !dbg !60 ; [#uses=1 type=[3 x i16]*] [debug line = 17:7]
  %25 = getelementptr inbounds [3 x i16]* %24, i32 0, i64 %20, !dbg !60 ; [#uses=1 type=i16*] [debug line = 17:7]
  store i16 0, i16* %25, align 2, !dbg !60        ; [debug line = 17:7]
  br label %26, !dbg !60                          ; [debug line = 17:7]

; <label>:26                                      ; preds = %18
  call void @llvm.dbg.declare(metadata !{i32* %k}, metadata !61), !dbg !63 ; [debug line = 18:24] [debug variable = k]
  store i32 0, i32* %k, align 4, !dbg !64         ; [debug line = 18:29]
  br label %27, !dbg !64                          ; [debug line = 18:29]

; <label>:27                                      ; preds = %61, %26
  %28 = load i32* %k, align 4, !dbg !64           ; [#uses=1 type=i32] [debug line = 18:29]
  %29 = icmp slt i32 %28, 3, !dbg !64             ; [#uses=1 type=i1] [debug line = 18:29]
  br i1 %29, label %30, label %64, !dbg !64       ; [debug line = 18:29]

; <label>:30                                      ; preds = %27
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !65 ; [debug line = 18:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !65 ; [debug line = 18:44]
...
; <label>:61                                      ; preds = %30
  %62 = load i32* %k, align 4, !dbg !69           ; [#uses=1 type=i32] [debug line = 18:38]
  %63 = add nsw i32 %62, 1, !dbg !69              ; [#uses=1 type=i32] [debug line = 18:38]
  store i32 %63, i32* %k, align 4, !dbg !69       ; [debug line = 18:38]
  br label %27, !dbg !69                          ; [debug line = 18:38]
...
!53 = metadata !{i32 786688, metadata !54, metadata !"j", metadata !6, i32 14, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!54 = metadata !{i32 786443, metadata !52, i32 14, i32 10, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!55 = metadata !{i32 14, i32 18, metadata !54, null}
!56 = metadata !{i32 14, i32 23, metadata !54, null}
!57 = metadata !{i32 14, i32 38, metadata !58, null}
!58 = metadata !{i32 786443, metadata !54, i32 14, i32 37, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!59 = metadata !{i32 15, i32 1, metadata !58, null}
!60 = metadata !{i32 17, i32 7, metadata !58, null}
!61 = metadata !{i32 786688, metadata !62, metadata !"k", metadata !6, i32 18, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!62 = metadata !{i32 786443, metadata !58, i32 18, i32 16, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!63 = metadata !{i32 18, i32 24, metadata !62, null}
!64 = metadata !{i32 18, i32 29, metadata !62, null}
!65 = metadata !{i32 18, i32 44, metadata !66, null}
!66 = metadata !{i32 786443, metadata !62, i32 18, i32 43, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!67 = metadata !{i32 20, i32 9, metadata !66, null}
!68 = metadata !{i32 21, i32 7, metadata !66, null}
!69 = metadata !{i32 18, i32 38, metadata !62, null}
!70 = metadata !{i32 22, i32 5, metadata !58, null}
!71 = metadata !{i32 14, i32 32, metadata !54, null}
