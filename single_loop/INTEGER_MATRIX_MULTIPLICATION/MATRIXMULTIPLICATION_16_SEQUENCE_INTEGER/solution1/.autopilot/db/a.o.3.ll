; ModuleID = '/opt/Xilinx/Vivado_HLS/2017.2/bin/INTEGER_MATRIX_MULTIPLICATION/MATRIXMULTIPLICATION_16_SEQUENCE_INTEGER/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:1                                       ; preds = %8, %0
  ...
  %exitcond2 = icmp eq i2 %i, -1, !dbg !50        ; [#uses=1 type=i1] [debug line = 10:21]
  ...
  br i1 %exitcond2, label %9, label %2, !dbg !50  ; [debug line = 10:21]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str) nounwind, !dbg !54 ; [debug line = 10:36]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str) nounwind, !dbg !54 ; [#uses=1 type=i32] [debug line = 10:36]
  %tmp_cast = zext i2 %i to i5                    ; [#uses=1 type=i5]
  %tmp_9 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %i, i2 0) ; [#uses=1 type=i4]
  %p_shl_cast = zext i4 %tmp_9 to i5, !dbg !56    ; [#uses=1 type=i5] [debug line = 18:9]
  %tmp_s = sub i5 %p_shl_cast, %tmp_cast, !dbg !56 ; [#uses=2 type=i5] [debug line = 18:9]
  br label %3, !dbg !61                           ; [debug line = 13:23]

; <label>:3                                       ; preds = %7, %2
  %j = phi i2 [ 0, %2 ], [ %j_1, %7 ]             ; [#uses=3 type=i2]
  %exitcond1 = icmp eq i2 %j, -1, !dbg !61        ; [#uses=1 type=i1] [debug line = 13:23]
  %empty_2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  %j_1 = add i2 %j, 1, !dbg !62                   ; [#uses=1 type=i2] [debug line = 13:32]
  br i1 %exitcond1, label %8, label %4, !dbg !61  ; [debug line = 13:23]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str1) nounwind, !dbg !63 ; [debug line = 13:38]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str1) nounwind, !dbg !63 ; [#uses=1 type=i32] [debug line = 13:38]
  %tmp_2_cast = zext i2 %j to i5, !dbg !64        ; [#uses=2 type=i5] [debug line = 16:7]
  %tmp_2 = add i5 %tmp_s, %tmp_2_cast, !dbg !64   ; [#uses=1 type=i5] [debug line = 16:7]
  %tmp_11_cast = sext i5 %tmp_2 to i64, !dbg !64  ; [#uses=1 type=i64] [debug line = 16:7]
  %res_addr = getelementptr [9 x i16]* %res, i64 0, i64 %tmp_11_cast, !dbg !64 ; [#uses=1 type=i16*] [debug line = 16:7]
  br label %5, !dbg !65                           ; [debug line = 17:29]

; <label>:5                                       ; preds = %6, %4
  %res_load = phi i16 [ 0, %4 ], [ %tmp_8, %6 ]   ; [#uses=2 type=i16]
  %k = phi i2 [ 0, %4 ], [ %k_1, %6 ]             ; [#uses=4 type=i2]
  store i16 %res_load, i16* %res_addr, align 2, !dbg !56 ; [debug line = 18:9]
  %exitcond = icmp eq i2 %k, -1, !dbg !65         ; [#uses=1 type=i1] [debug line = 17:29]
  %empty_3 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  %k_1 = add i2 %k, 1, !dbg !66                   ; [#uses=1 type=i2] [debug line = 17:38]
  br i1 %exitcond, label %7, label %6, !dbg !65   ; [debug line = 17:29]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName([8 x i8]* @p_str2) nounwind, !dbg !67 ; [debug line = 17:44]
  %tmp_4_cast = zext i2 %k to i5, !dbg !56        ; [#uses=2 type=i5] [debug line = 18:9]
  %tmp_4 = add i5 %tmp_s, %tmp_4_cast, !dbg !56   ; [#uses=1 type=i5] [debug line = 18:9]
  %tmp_12_cast = sext i5 %tmp_4 to i64, !dbg !56  ; [#uses=1 type=i64] [debug line = 18:9]
  %a_addr = getelementptr [9 x i8]* %a, i64 0, i64 %tmp_12_cast, !dbg !56 ; [#uses=1 type=i8*] [debug line = 18:9]
  %tmp_10 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %k, i2 0) ; [#uses=1 type=i4]
  %p_shl1_cast = zext i4 %tmp_10 to i5, !dbg !56  ; [#uses=1 type=i5] [debug line = 18:9]
  %tmp_11 = sub i5 %p_shl1_cast, %tmp_4_cast, !dbg !56 ; [#uses=1 type=i5] [debug line = 18:9]
  %tmp_12 = add i5 %tmp_11, %tmp_2_cast, !dbg !56 ; [#uses=1 type=i5] [debug line = 18:9]
  %tmp_15_cast = sext i5 %tmp_12 to i64, !dbg !56 ; [#uses=1 type=i64] [debug line = 18:9]
  %b_addr = getelementptr [9 x i8]* %b, i64 0, i64 %tmp_15_cast, !dbg !56 ; [#uses=1 type=i8*] [debug line = 18:9]
  %a_load = load i8* %a_addr, align 1, !dbg !56   ; [#uses=1 type=i8] [debug line = 18:9]
  %tmp_5 = sext i8 %a_load to i16, !dbg !56       ; [#uses=1 type=i16] [debug line = 18:9]
  %b_load = load i8* %b_addr, align 1, !dbg !56   ; [#uses=1 type=i8] [debug line = 18:9]
  %tmp_6 = sext i8 %b_load to i16, !dbg !56       ; [#uses=1 type=i16] [debug line = 18:9]
  %tmp_7 = mul i16 %tmp_6, %tmp_5, !dbg !56       ; [#uses=1 type=i16] [debug line = 18:9]
  %tmp_8 = add i16 %tmp_7, %res_load, !dbg !56    ; [#uses=1 type=i16] [debug line = 18:9]
  call void @llvm.dbg.value(metadata !{i2 %k_1}, i64 0, metadata !68), !dbg !66 ; [debug line = 17:38] [debug variable = k]
  br label %5, !dbg !66                           ; [debug line = 17:38]

; <label>:7                                       ; preds = %5
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str1, i32 %tmp_3) nounwind, !dbg !70 ; [#uses=0 type=i32] [debug line = 20:5]
  call void @llvm.dbg.value(metadata !{i2 %j_1}, i64 0, metadata !71), !dbg !62 ; [debug line = 13:32] [debug variable = j]
  br label %3, !dbg !62                           ; [debug line = 13:32]

; <label>:8                                       ; preds = %3
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str, i32 %tmp_1) nounwind, !dbg !72 ; [#uses=0 type=i32] [debug line = 21:3]
  call void @llvm.dbg.value(metadata !{i2 %i_1}, i64 0, metadata !73), !dbg !53 ; [debug line = 10:30] [debug variable = i]
  br label %1, !dbg !53                           ; [debug line = 10:30]

; <label>:9                                       ; preds = %1
  ret void, !dbg !74                              ; [debug line = 22:1]
}
...
!23 = metadata !{i32 786473, metadata !"../../../../../../home/drsatya/Desktop/lab1/matrixmul.cpp", metadata !"/opt/Xilinx/Vivado_HLS/2017.2/bin/INTEGER_MATRIX_MULTIPLICATION", null} ; [ DW_TAG_file_type ]
...
!54 = metadata !{i32 10, i32 36, metadata !55, null}
!55 = metadata !{i32 786443, metadata !51, i32 10, i32 35, metadata !23, i32 2} ; [ DW_TAG_lexical_block ]
!56 = metadata !{i32 18, i32 9, metadata !57, null}
!57 = metadata !{i32 786443, metadata !58, i32 17, i32 43, metadata !23, i32 6} ; [ DW_TAG_lexical_block ]
!58 = metadata !{i32 786443, metadata !59, i32 17, i32 16, metadata !23, i32 5} ; [ DW_TAG_lexical_block ]
!59 = metadata !{i32 786443, metadata !60, i32 13, i32 37, metadata !23, i32 4} ; [ DW_TAG_lexical_block ]
!60 = metadata !{i32 786443, metadata !55, i32 13, i32 10, metadata !23, i32 3} ; [ DW_TAG_lexical_block ]
!61 = metadata !{i32 13, i32 23, metadata !60, null}
!62 = metadata !{i32 13, i32 32, metadata !60, null}
!63 = metadata !{i32 13, i32 38, metadata !59, null}
!64 = metadata !{i32 16, i32 7, metadata !59, null}
!65 = metadata !{i32 17, i32 29, metadata !58, null}
!66 = metadata !{i32 17, i32 38, metadata !58, null}
!67 = metadata !{i32 17, i32 44, metadata !57, null}
!68 = metadata !{i32 786688, metadata !58, metadata !"k", metadata !23, i32 17, metadata !69, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!69 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!70 = metadata !{i32 20, i32 5, metadata !59, null}
!71 = metadata !{i32 786688, metadata !60, metadata !"j", metadata !23, i32 13, metadata !69, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!72 = metadata !{i32 21, i32 3, metadata !55, null}
!73 = metadata !{i32 786688, metadata !51, metadata !"i", metadata !23, i32 10, metadata !69, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!74 = metadata !{i32 22, i32 1, metadata !52, null}
