...
(* CORE_GENERATION_INFO="matrixmul,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a35tcpg236-3,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.356000,HLS_SYN_LAT=79,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=1,HLS_SYN_FF=137,HLS_SYN_LUT=142}" *)
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond1_fu_155_p2))) begin
        res_addr_reg_278 <= tmp_11_cast_fu_176_p1;
        tmp_2_cast_reg_273[1 : 0] <= tmp_2_cast_fu_167_p1[1 : 0];
    end
end
...
assign res_address0 = res_addr_reg_278;
...
assign tmp_12_fu_225_p2 = (tmp_11_fu_219_p2 + tmp_2_cast_reg_273);

assign tmp_15_cast_fu_230_p1 = $signed(tmp_12_fu_225_p2);

assign tmp_2_cast_fu_167_p1 = j_reg_86;

assign tmp_2_fu_171_p2 = (tmp_s_reg_259 + tmp_2_cast_fu_167_p1);

assign tmp_4_cast_fu_193_p1 = k_reg_110;

assign tmp_4_fu_197_p2 = (tmp_s_reg_259 + tmp_4_cast_fu_193_p1);
