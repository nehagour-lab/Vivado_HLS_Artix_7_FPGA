...
architecture behav of matrixmul is 
    ...
    "matrixmul,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a35tcpg236-3,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.356000,HLS_SYN_LAT=79,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=1,HLS_SYN_FF=137,HLS_SYN_LUT=142}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond1_fu_155_p2))) then
                res_addr_reg_278 <= tmp_11_cast_fu_176_p1(4 - 1 downto 0);
                    tmp_2_cast_reg_273(1 downto 0) <= tmp_2_cast_fu_167_p1(1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond2_fu_121_p2 = ap_const_lv1_0))) then
                tmp_s_reg_259 <= tmp_s_fu_149_p2;
            end if;
        end if;
    end process;
    tmp_2_cast_reg_273(4 downto 2) <= "000";
    ...
    tmp_12_fu_225_p2 <= std_logic_vector(unsigned(tmp_11_fu_219_p2) + unsigned(tmp_2_cast_reg_273));
    ...
    tmp_2_fu_171_p2 <= std_logic_vector(unsigned(tmp_s_reg_259) + unsigned(tmp_2_cast_fu_167_p1));
    tmp_4_cast_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_reg_110),5));
    tmp_4_fu_197_p2 <= std_logic_vector(unsigned(tmp_s_reg_259) + unsigned(tmp_4_cast_fu_193_p1));
