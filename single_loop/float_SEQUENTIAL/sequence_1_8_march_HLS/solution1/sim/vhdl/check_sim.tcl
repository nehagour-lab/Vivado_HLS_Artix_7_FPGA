...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.simple.autotvin_a.dat"
         "c.simple.autotvin_b.dat"
         "c.simple.autotvin_c.dat"
         "c.simple.autotvout_c.dat"
         "c.simple.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.simple.autotvout_c.dat"
         "rtl.simple.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
