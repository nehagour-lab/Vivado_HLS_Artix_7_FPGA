; ModuleID = '/opt/Xilinx/Vivado_HLS/2017.2/bin/sequence_1_8_march/solution1/.autopilot/db/a.g.1.bc'
...
define float @simple(float* %a, float* %b, float* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayDimSize(float* %a, i32 8) nounwind, !dbg !37 ; [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayDimSize(float* %b, i32 8) nounwind, !dbg !39 ; [debug line = 5:30]
  call void (...)* @_ssdm_SpecArrayDimSize(float* %c, i32 8) nounwind, !dbg !40 ; [debug line = 5:58]
  br label %1, !dbg !41                           ; [debug line = 7:5]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i, 8, !dbg !41         ; [#uses=1 type=i1] [debug line = 7:5]
  br i1 %exitcond, label %3, label %2, !dbg !41   ; [debug line = 7:5]

; <label>:2                                       ; preds = %1
  %tmp = sext i32 %i to i64, !dbg !43             ; [#uses=3 type=i64] [debug line = 10:7]
  %a.addr = getelementptr inbounds float* %a, i64 %tmp, !dbg !43 ; [#uses=1 type=float*] [debug line = 10:7]
  %a.load = load float* %a.addr, align 4, !dbg !43 ; [#uses=2 type=float] [debug line = 10:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %a.load) nounwind
  %b.addr = getelementptr inbounds float* %b, i64 %tmp, !dbg !43 ; [#uses=1 type=float*] [debug line = 10:7]
  %b.load = load float* %b.addr, align 4, !dbg !43 ; [#uses=2 type=float] [debug line = 10:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %b.load) nounwind
  %tmp.1 = fadd float %a.load, %b.load, !dbg !43  ; [#uses=1 type=float] [debug line = 10:7]
  %c.addr = getelementptr inbounds float* %c, i64 %tmp, !dbg !43 ; [#uses=1 type=float*] [debug line = 10:7]
  store float %tmp.1, float* %c.addr, align 4, !dbg !43 ; [debug line = 10:7]
  %i.1 = add nsw i32 %i, 1, !dbg !45              ; [#uses=1 type=i32] [debug line = 7:14]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !46), !dbg !45 ; [debug line = 7:14] [debug variable = i]
  br label %1, !dbg !45                           ; [debug line = 7:14]

; <label>:3                                       ; preds = %1
  ret float 0.000000e+00, !dbg !47                ; [debug line = 13:5]
}
...
!39 = metadata !{i32 5, i32 30, metadata !38, null}
!40 = metadata !{i32 5, i32 58, metadata !38, null}
!41 = metadata !{i32 7, i32 5, metadata !42, null}
!42 = metadata !{i32 786443, metadata !38, i32 7, i32 1, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!43 = metadata !{i32 10, i32 7, metadata !44, null}
!44 = metadata !{i32 786443, metadata !42, i32 8, i32 5, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!45 = metadata !{i32 7, i32 14, metadata !42, null}
!46 = metadata !{i32 786688, metadata !38, metadata !"i", metadata !6, i32 6, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!47 = metadata !{i32 13, i32 5, metadata !38, null}
