...
HD_PWD='/opt/Xilinx/Vivado/2017.2/bin/UNROLL_FLOAT_9_MARCH_NEW_1_2_1/UNROLL_FLOAT_9_MARCH_NEW_1_2_1.runs/design_1_simple_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_simple_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_simple_0_0.tcl
